...
def main() -> None:
    ...
    # 3) Save CSV
    out_path = Path(__file__).parent / "csv2" / "2metrics_rrf_llm_working32.csv"
...
if __name__ == "__main__":
    try:
        main()
        send_email("✅ Script completed", "Your reranking script finished successfully. 2metrics_rrf_llm_working32.csv")
    except Exception as e:
        send_email("❌ Script failed", f"Your reranking script failed with error:\n\n{e} 2metrics_rrf_llm_working32.csv")
