...
def main() -> None:
    ...
    # 3) Save CSV
    out_path = Path(__file__).parent / "csv3" / "3metrics_rrf_llm_working3.csv"
...
if __name__ == "__main__":
    try:
        main()
        send_email("✅ Script completed", "Your reranking script finished successfully. 3metrics_rrf_llm_working3.csv")
    except Exception as e:
        send_email("❌ Script failed", f"Your reranking script failed with error:\n\n{e} 3metrics_rrf_llm_working3.csv")
