...
if __name__=="__main__":
    ...
    # 2) batch-embed paragraph + concepts in ONE forward pass
    texts = [args.paragraph] + info["concepts"]
    vecs  = sci_model.encode(texts, convert_to_numpy=True,
                            normalize_embeddings=True)
    qvec, concept_vecs = vecs[0], vecs[1:]           # unpack
